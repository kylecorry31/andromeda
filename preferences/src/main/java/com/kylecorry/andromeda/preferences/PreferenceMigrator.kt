...
class PreferenceMigrator(private val context: Context, private val versionKey: String) {
    ...
    fun migrate(toVersion: Int, migrations: List<PreferenceMigration>) {
        synchronized(lock) {
            ...
            var currentVersion = prefs.getInt(versionKey) ?: 0
            ...
            while (currentVersion < toVersion) {
                ...
                currentVersion++
                prefs.putInt(versionKey, currentVersion)
            }
        }
    }
}